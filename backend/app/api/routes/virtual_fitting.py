...
async def save_leffa_result(
    ...
    try:
        ...
        if not result_name or not image_urls:
            raise HTTPException(status_code=400, detail="결과 이름과 이미지가 필요합니다.")
            ...
            for idx, image_url in enumerate(image_urls):
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        filename = f"user_{current_user.user_id}_{timestamp}_{random_hex}.png"
        ...
        return {"message": "결과가 저장되었습니다.", "fitting_id": new_fitting.fitting_id}
