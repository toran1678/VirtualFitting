 ...
 * 기술 스택:
 * - HTTP Client: Axios
 * - OAuth 2.0: 카카오 로그인 API
 * - 인증: 세션 쿠키 기반
 * - 파일 업로드: FormData (프로필 사진)
 *
 * 사용 예시:
 * - 소셜 로그인 버튼 클릭
 * - 카카오 인증 후 리다이렉트 처리
 ...
 *
 * 인증 플로우:
 * 1. getKakaoAuthUrl() - 카카오 인증 URL 생성
 * 2. 사용자가 카카오에서 인증
 * 3. processKakaoAuth() - 인증 코드로 로그인/회원가입 처리
 * 4. 필요시 kakaoSignup() - 추가 정보 입력 후 회원가입
 *
 * 주의사항:
 * - checkKakaoUser, kakaoLogin 함수는 DEPRECATED
 * - processKakaoAuth 사용 권장 (통합 처리)
 * ===================================================================
 */
